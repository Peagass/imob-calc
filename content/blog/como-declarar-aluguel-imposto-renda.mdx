---
title: "Como Declarar Aluguel Recebido no Imposto de Renda 2026"
...
- Alíquota: 7,5% → IR = R$ 2.750 × 7,5% − R$ 169,44 = **R$ 36,81/mês**
- IR anual: **R$ 441,72**

Agora, se você também tem um salário de R$ 4.000:

- Base total: R$ 4.000 + R$ 2.750 = R$ 6.750
- IR sobre R$ 6.750 = R$ 6.750 × 27,5% − R$ 896 = **R$ 960,25**
- IR só sobre o salário = R$ 4.000 × 22,5% − R$ 662,77 = **R$ 237,23**
- IR marginal do aluguel = R$ 960,25 − R$ 237,23 = **R$ 723,02/mês**

A diferença é enorme. O aluguel sozinho geraria R$ 36,81 — com o salário, gera R$ 723,02. É por isso que o simulador precisa considerar todas as suas rendas.
...
Você não paga IR sobre aluguel quando a **base de cálculo mensal** (após deduções) fica abaixo de R$ 2.259,20 — o limite de isenção da tabela progressiva de 2024.

Mas atenção: mesmo isento, você deve declarar o aluguel na declaração anual se estiver obrigado a declarar IRPF (o que acontece se a soma dos rendimentos superar o limite anual de obrigatoriedade).
