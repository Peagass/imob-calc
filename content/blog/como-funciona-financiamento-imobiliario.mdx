...
Use o simulador do CalcImóvel para comparar SAC vs PRICE com os juros do banco que você está avaliando — e veja o impacto em parcelas, juros totais e evolução do saldo devedor mês a mês.
